...
from utils import translate, resize, compose_image, update_lists, update_crop_index, read_mask
import torch
...
if __name__ == "__main__":
    ...
    parser.add_argument("--nb_videos", type=int, default=1000, help='number of videos we want to generate')
    parser.add_argument("--nb_frames", type=int, default=1, help='number of frames to generate')
    ...
    while video < args.nb_videos:
        ...
        try:    
            ...
            for p in range(args.nb_frames):
                ...
                # Compose the image
                all_in_focus, bokeh, mask, sigma = compose_image(background, foreground_list, mask_list, args.sigma)
